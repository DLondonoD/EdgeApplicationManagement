...
Sandbox API Repository to describe, develop, document, and test the EdgeApplicationManagement Service API(s). The repository does not yet belong to a CAMARA Sub Project.
...
Incubating API Repository to evolve and maintain the definitions and documentation of EdgeApplicationManagement Service API(s) within the Sub Project [EdgeCloud](https://lf-camaraproject.atlassian.net/wiki/x/ujLe)
...
Repository for xxx of the EdgeCloud Working Group"

* Working Group [wiki home page](https://lf-camaraproject.atlassian.net/wiki/x/ujLe) 
...
* Meetings are held virtually <!-- for new, independent Sandbox API repositories request a meeting link from the LF admin team or replace the information with the existing meeting information of the Sub Project -->
  ...
  * Minutes: Access [meeting minutes](https://lf-camaraproject.atlassian.net/wiki/x/ujLe) !! update this link to your minutes archive page using the "Share" link and delete the task
* Mailing List
